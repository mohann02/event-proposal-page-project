...
//Array.from(e.target.files)
    ...
    return (
        <section className="container">
            ...
            <button className="into-symbol"><Link to="/proposalsData" style={{ textDecoration: 'none' }}>X</Link></button>
            </section>
            <form className="form-container">
                ...
                <section className="leftSide-container">
                    ...
                    <input type="text" id="eventName" onChange={handleEventNameChange}
                        name="eventName" value={eventName} placeholder="Name" required/>
                    <section style={{ display: "flex", justifyContent:"space-between" }} className="side-by-side-inputs">
                        <section>
                            <section className="label-text">
                                <label htmlFor="placeOfEvent">Place Of Event</label>
                            </section>
                            <select id="placeOfEvent" onChange={handlePlaceOfEventChange}
                                name="placeOfEvent" value={placeOfEvent} required>
                        ...
                        <section>
                            ...
                            <select id="proposalType" onChange={handleProposalTypeChange}
                                name="proposalType" value={proposalType} required >
                                     <option>Select</option>
                    ...
                    <section style={{ display: "flex", justifyContent:"space-between" }} className="side-by-side-inputs">
                        <section>
                            ...
                            <select id="eventType" onChange={handleEvneTypeChange}
                                name="eventType" value={eventType} required>
                                     <option>Select</option>
                        ...
                        <section>
                            ...
                            <input type="number" id="budget" onChange={handleBudgetChange}
                                name="budget" value={budget} placeholder="000000" required/>
                        </section>
                    </section>
                    <section style={{ display: "flex", justifyContent:"space-between" }} className="side-by-side-inputs">
                        <section>
                            ...
                            <input type="date" id="fromDate" onChange={handleFromDateChange}
                                name="fromDate" value={fromDate} required />
                        </section>
                        <section>
                            <section className="label-text">
                            ...
                            <input type="date" id="toDate" onChange={handleToDateChange}
                                name="toDate" value={toDate}  required/>
                        </section>
                    </section>
                    <section>
                        <section className="label-text">
                        ...
                        <textarea type="textarea" id="description" onChange={handleDescriptionChange}
                            name="description" value={description} placeholder="Description" required />
                    </section>
                </section>
                <section className="rightSide-container">
                    <section className="file-container">
                        <label htmlFor="postImage">Images</label>
                        <input className="file-input-container" type="file" name="postImage" id="postImage" multiple  onChange={handleImageChange} required/>
                    </section>
                    <div className="preview-images-container">
          {previewImages.map((images,index) => (
            <img key={index} src={images} alt="previewImages" width="50" height="50" />
          ))}
        </div>
                    <section>
                        <section className="label-text">
                        ...
                        <textarea type="textarea" id="foodPreferences" onChange={handleFoodPreferencesChange}
                            name="foodPreferences" value={foodPreferences} placeholder="Preferences" required />
                    </section>
                    <section>
                    </section>
                    <section className="label-text">
                    ...
                    <textarea type="textarea" id="events" onChange={handleEventsChange}
                        name="events" value={events} placeholder="Events" required/>
                </section>
                </section>
                <section className="button-container">
                <button type="submit" onClick={handleSubmit}><Link to="/proposalsData" style={{ textDecoration: 'none', color:"white"}}>{previewImages.length > 0 ? 'POST' : 'ADD'}</Link></button>
